...
//
  ...
  enum Code {
    ...
    SSL_GENERATING_SSL_CREDENTIALS,
    SSL_GENERATING_RSA_PAIR,
    ...
    INFO_SSL_KEY_PATH,
    INFO_SSL_CERT_PATH,
    INFO_JWT_ACCESS_PUBKEY_PATH,
    INFO_JWT_ACCESS_PRIVKEY_PATH,
    INFO_JWT_REFRESH_PUBKEY_PATH,
    INFO_JWT_REFRESH_PRIVKEY_PATH,
    INFO_DB_PATH,
    INFO_HOST,
    ...
    //  instruction
    USERNAME_NEW_INSTRUCTION,
    USERNAME_MODIFY_INSTRUCTION,
    USERNAME_REMOVE_INSTRUCTION,
    PASSWORD_NEW_INSTRUCTION,
    REMOVE_DOUBLE_CHECK_INSTRUCTION,
